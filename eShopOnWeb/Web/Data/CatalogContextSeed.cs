...
namespace Web.Data
{
    ...
    public class CatalogContextSeed
    {
        ...
        static IEnumerable<CatalogItem> GetPreconfiguredItems()
        {
            ...
            {
                new CatalogItem() { CatalogTypeId=2,CatalogBrandId=2, Description = ".NET Bot Black Sweatshirt", Name = ".NET Bot Black Sweatshirt", Price = 19.5, PictureUri = "http://catalogbaseurltobereplaced/catalog/pic/1" },
                new CatalogItem() { CatalogTypeId=1,CatalogBrandId=2, Description = ".NET Black & White Mug", Name = ".NET Black & White Mug", Price= 8.50, PictureUri = "http://catalogbaseurltobereplaced/catalog/pic/2" },
                ...
                new CatalogItem() { CatalogTypeId=3,CatalogBrandId=5, Description = "Roslyn Red Sheet", Name = "Roslyn Red Sheet", Price = 8.5, PictureUri = "http://catalogbaseurltobereplaced/catalog/pic/5" },
                ...
                new CatalogItem() { CatalogTypeId=2,CatalogBrandId=5, Description = "Kudu Purple Sweatshirt", Name = "Kudu Purple Sweatshirt", Price = 8.5, PictureUri = "http://catalogbaseurltobereplaced/catalog/pic/8" },
                ...
                new CatalogItem() { CatalogTypeId=3,CatalogBrandId=2, Description = "Cup<T> Sheet", Name = "Cup<T> Sheet", Price = 8.5, PictureUri = "http://catalogbaseurltobereplaced/catalog/pic/11" },
